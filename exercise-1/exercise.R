...
#make data frame in which you are viewing all the vehicles in the year 1997
#start inside out, so go to year row in the vehicles df equal to 1997 and store in
#data frame cars_1997
